...
void sha256(const uint8_t *buffer, uint32_t *words, const uint32_t nb_read_bytes, const uint32_t buffer_size, struct function_infos *func);

void sha512(const uint8_t *buffer, uint64_t *words, const uint32_t nb_read_bytes, const uint32_t buffer_size, struct function_infos *func);
